...
COMMANDS = [
    ...
    {"name": "/status", "title": "状态", "category": "基础", "description": "查看萤当前运行状态；手机端同时显示生活状态。", "platforms": ["telegram", "mobile"], "owner": True, "usage": "/status"},
    {"name": "/time", "title": "时间", "category": "基础", "description": "查看萤当前采用的北京时间。", "platforms": ["telegram", "mobile"], "owner": False, "usage": "/time"},
