    ...
    *,
    ...
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        migrations = {
            ...
            "mode":
                "ALTER TABLE activity_history ADD COLUMN mode TEXT NOT NULL DEFAULT 'normal'",

            "detail":
                "ALTER TABLE activity_history ADD COLUMN detail TEXT",

            "duration_minutes":
                "ALTER TABLE activity_history ADD COLUMN duration_minutes REAL",
        }
